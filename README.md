...
For the Backend, no AI agents or vibe coding platforms were used in developing this project. We used Anthropic's Claude AI for some initial research and Google's Gemini AI for a few of our AI features. Finally, no personally identifiable data is exposed to unethical use.

For the Frontend with Flutter, there were uses of Anthropic's Claude AI and Google's Gemini AI for implementing some ui screens for faster iterations
