...
import 'package:light_x/features/onboarding/ui/screens/onboarding_2.dart';
...
final onboardingRoutes = [
  ...
  GoRoute(
    path: Routes.onboarding2.path,
    name: Routes.onboarding2.name,
    builder: (context, state) =>
        ChangeNotifierProvider(create: (c) => OnboardingProvider(), child: const Onboarding2()),
  ),
];
