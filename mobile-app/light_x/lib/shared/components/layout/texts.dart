...
class AppTexts {
  static Widget pageAppBarTitleText(String title, [double? fontSize]) {
    return AppText(title, fontSize: fontSize ?? 20, fontWeight: FontWeight.w600, color: AppColors.neutralBlack500);
  }
